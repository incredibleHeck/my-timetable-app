...
describe('Generator - Class Structure Fixed Slots', () => {
  ...
  const mockData: AppData = {
    ...
    classes: [
      {
        ...
        periodCount: 8,
        curriculum: [
          { subjectId: "math", singles: 5, doubles: 0, assignedTeacherId: "t1" }
        ],
    ...
    teachers: [
      { id: "t1", name: "Teacher 1", constraints: [] }
    ],
    subjects: [
      { id: "math", name: "Math" }
    ],
    rooms: [
      { id: "room-1", name: "Room 1", capacity: 30, type: "Standard" }
    ],
    schedule: {},
    jointClasses: [],
    electives: [],
  ...
  it('should enforce total curriculum subject limits', () => {
     ...
     const dataWithOverload: AppData = {
         ...
         schedule: {
             "class-1": {
                 0: {
                     2: { unitId: "u1", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false },
                     3: { unitId: "u2", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false },
                     4: { unitId: "u3", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false },
                     5: { unitId: "u4", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false },
                     6: { unitId: "u5", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false },
                     7: { unitId: "u6", subjectId: "math", teacherId: "t1", classId: "class-1", roomId: "room-1", isFixed: false }, // 6th period, but limit is 5
                 }
             }
         }
     };
