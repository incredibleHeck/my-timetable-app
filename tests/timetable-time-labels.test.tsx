...
describe("DraggableSlot Time Labels", () => {
  ...
  it("should render timeRange when in TEACHER mode", () => {
    render(
      <DraggableSlot slot={mockSlot} day={0} period={0} mode="TEACHER" timeRange="09:00 - 09:50" />,
    );
  ...
  it("should not render timeRange when in CLASS mode even if provided", () => {
    render(
      <DraggableSlot slot={mockSlot} day={0} period={0} mode="CLASS" timeRange="09:00 - 09:50" />,
    );
