  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        } rounded-xl text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-canvas transition-all placeholder:text-content-muted ${className}`}
        {...props}
      />
