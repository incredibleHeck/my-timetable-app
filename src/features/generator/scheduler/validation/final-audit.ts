    ...
    for (const dayStr of Object.keys(classSchedule)) {
      ...
      for (const periodStr of Object.keys(daySchedule)) {
        ...
        if (slot.teacherId) {
          ...
          if (!teacherOccupancy[slot.teacherId][day][period])
            teacherOccupancy[slot.teacherId][day][period] = [];
        ...
        if (slot.roomId) {
          ...
          if (!roomOccupancy[slot.roomId][day][period])
            roomOccupancy[slot.roomId][day][period] = [];
