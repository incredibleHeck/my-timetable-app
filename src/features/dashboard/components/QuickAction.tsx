...
export const QuickAction: React.FC<QuickActionProps> = ({ icon, label, desc, onClick }) => (
  ...
  >
    <div className="p-3 bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-300 rounded-lg group-hover:bg-amber-50 group-hover:text-accent-ink transition-colors">
      {icon}
    </div>
