...
- Name: app.spec.ts >> Profile bootstrap >> loads seeded profile to dashboard
...
Locator: locator('strong:has-text("E2E School")')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('strong:has-text("E2E School")')
